...
function lgyzngc_ContigFilter(url, auth, auth_cb, timeout, async_job_check_time_ms, async_version) {
    var self = this;
    ...
    this._check_job = function (job_id, _callback, _errorCallback) {
        ...
        return json_call_ajax("lgyzngc_ContigFilter._check_job", 
     ...
     this.filter_contigs = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax("lgyzngc_ContigFilter.filter_contigs",
