...
from lgyzngc_ContigFilter.lgyzngc_ContigFilterServer import MethodContext


class lgyzngc_ContigFilterTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        for nameval in config.items('lgyzngc_ContigFilter'):
            cls.cfg[nameval[0]] = nameval[1]
        cls.wsURL = cls.cfg['workspace-url']
        cls.wsClient = workspaceService(cls.wsURL, token=token)
        cls.serviceImpl = lgyzngc_ContigFilter(cls.cfg)
    ...
    def getWsName(self):
        ...
        wsName = "test_lgyzngc_ContigFilter_" + str(suffix)
